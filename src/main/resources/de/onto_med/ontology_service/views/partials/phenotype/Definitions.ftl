	...
	<div class="col-sm-10" id="definition-div">
		<div class="input-group hidden">
			<div class="input-group-addon">
				<select name="definitionLanguages[]" data-toggle="tooltip" title="Language" data-placement="right">
			...
			<textarea class="form-control" name="definitions[]" placeholder="Some Definition"></textarea>
		</div>
	</div>
</div>